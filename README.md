...
<div align = "left" style ="margin: 20px; font-size: 16px;">
    <p><strong>Name:</strong>  SNEHA ROY </p>
    <p><strong>Email ID:</strong> sneharoy4002@gmail.com  </p>
    <p><strong>College Name:</strong>  SILIGURI INSTITUTE OF TECHNOLOGY </p>
    <p><strong>Branch/Specialization :</strong>  BACHELOR OF TECHNOLOGY IN COMPUTER SCIENCE AND ENGINEERING </p>
    <p><strong>College ID:</strong>  11900122014 </p>
</div>
...
<div align="left" style="margin: 20px; font-size: 16px;">
    ...
    <p><strong>Instructor Name:</strong> MR SEN HARIHARAN </p>
</div>
<div align="left" style="margin: 20px; font-size: 16px;">
...
During my internship at Sure Trust, I gained a basic understanding of cybersecurity and how data can be protected using encryption techniques. I learned about concepts like AES, RSA, and how they are used in real-world applications. Working on this project helped me understand how security is actually implemented in code, not just theory. I also improved my problem-solving and debugging skills while handling errors in encryption and decryption. Overall, it was a very practical learning experience that gave me confidence in cybersecurity basics.


<h2 style="color:#333;"> Projects Completed </h2>
<div align="left" style="margin: 20px; font-size: 16px;">

<p><strong><a href="#project1">Project 1:</a></strong>DATA ENCRYPTION AND FILE SECURITY TOOL</p>
...
<!-- Project 1 -->
<h3 id="project1">Project 1: DATA ENCRYPTION AND FILE SECURITY TOOL</h3>
<p>
  This project is a file security tool that uses AES-256, RSA, and hybrid encryption to protect data from unauthorized access.
It provides a simple interface to securely encrypt and decrypt files while ensuring both performance and strong security.
</p>
<p>
  <a href="https://github.com/sure-trust/SNEHA-ROY-g14-cs/blob/11e31e46768e22f199ad23b4236e1044bc1ae9ac/Course%20report/SURE%20Trust%20project%20report%20document.pdf" target="_blank"><strong>→ View Full Project Report</strong></a>
</p>
...
In the LST (Life Skills Training) sessions, I developed important skills like communication, time management, and confidence.
These sessions helped me improve my overall personality and better prepare for real-world situations.
---
